...
def run_interactive_menu(pod_name, pod_config_path, topic_mgr, episode_mgr):
    ...
    while True:
        ...
        print("13. 🛠️  Herramientas de Corrección (Escenas / Metadata YT)")
        print("0. Salir")
        ...
        if choice == "0":
            ...
            from src.utils.scene_regenerator import SceneRegenerator
            regen = SceneRegenerator(pod_name, pod_config_path)
            regen.run_interactive()
        else:
