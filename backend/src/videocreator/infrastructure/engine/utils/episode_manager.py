...
Uso:
    from videocreator.infrastructure.engine.utils.episode_manager import EpisodeManager
...
class EpisodeManager:
    ...
    def create_episode(
        ...
        log.info("episode_created", episode_id=episode_id, script=script_path, clips_dir=clips_dir)
